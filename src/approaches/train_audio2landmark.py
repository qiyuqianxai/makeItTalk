...
class Audio2landmark_model():
    ...
    def __train_pass__(self, au_emb=None, centerize_face=False, no_y_rotation=False, vis_fls=False, args=None):
    ...
    def test(self, au_emb=None, args=None):
        with torch.no_grad():
            self.__train_pass__(au_emb, vis_fls=True, args=args)
